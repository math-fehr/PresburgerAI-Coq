...
Class transfer_function_relational {abstract_state: eqType} {p: Program}
      ...
      (prog: Program) :=
  {
    ...
    transfer_inst_compose_transitive_closure :
      forall inst a comp_a,
        le (transfer_inst inst (compose_transitive_closure comp_a a))
           (compose_transitive_closure comp_a (transfer_inst inst a));
    ...
    transfer_term_compose_transitive_closure :
      forall term a a' comp_a bb,
        (a', bb) \in (transfer_term term (compose_transitive_closure comp_a a)) ->
                     exists a'', (a'', bb) \in transfer_term term a /\ le a' (compose_transitive_closure comp_a a'');
  }.
